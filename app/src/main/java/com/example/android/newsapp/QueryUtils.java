...
public final class QueryUtils {
    ...
    /**
     * Query the Guardianapis set and return a list of {@link News} objects.
     */
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                String webPublicationDate = currentResults.getString("webPublicationDate");
                ...
                News news = new News(webTitle, author, webPublicationDate, url);
